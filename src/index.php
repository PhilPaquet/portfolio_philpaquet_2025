...
<div id="smooth-wrapper" data-component="Scroller" data-pin-items="true" data-scroller-title="true">
    <div id="smooth-content">
            ...
            <div class="wrapper">
                ...
                <div class="hero_accueil__media_container">
                    <a href="#projets" class="hero_accueil__media border">
                        <video autoplay muted loop><source src="assets/videos/video_hero_accueil.mp4" type="video/mp4" /></video>
                    </a>
                    ...
                    <div class="projets_container" data-speed="1.15">
                        ...
                        <div class="projet_container pattern_croix">
                            <a href="proxima.html" class="projet">
                                <div class="projet__media border">
                                    <img src="./assets/images/thumbnail_proxima.webp" alt="Image à la une du projet Campagne marketing" />
                                </div>
                                <div class="projet__content border_text">
                                    <div class="titre_container">
                    ...
                    <div class="projets_container projets_container_right" data-speed="1.30">
                        <div class="projet_container">
                            <a href="bsc.html" class="projet">
                                <div class="projet__media border">
                                    <img src="./assets/images/thumbnail_bsc.webp" alt="Image à la une du projet Baie-Sainte-Catherine" />
                                </div>
                                <div class="projet__content border_text">
                                    <div class="titre_container">
                        ...
                        <div class="projet_container pattern_cercle">
                            <a href="tag-ball.html" class="projet">
                                <div class="projet__media border">
                                    <img src="./assets/images/thumbnail_tagball.webp" alt="Image à la une du projet Tag ball" />
                                </div>
                                <div class="projet__content border_text">
                                    <div class="titre_container">
                                        <h4>Tag ball</h4>
                        ...
                        <div class="projet_container">
                            <a href="amarsissage.html" class="projet">
                                <div class="projet__media border">Je suis une image</div>
                                <div class="projet__content border_text">
                                    <div class="titre_container">
                                        <h4>Projet</h4>
                                        <svg class="icon">
                        ...
                        <form action="" class="form" autocomplete="off" data-component="Form">
                            <fieldset class="form__grid">
                                ...
                                <div class="input textarea input--3">
                                    ...
                                    <textarea class="input__element border_text" name="message" id="message" placeholder="Votre message" required></textarea>
        ...
        <!-- 
<section class="pre_footer section_nobottom">
    <div class="wrapper">
        <h2>On jase ?</h2>
        <div class="points"></div>
    </div>
