...
<html lang="fr">
  ...
  <script>
    ...
    <meta name="description" content="Découvre le portfolio de Philippe Paquet, créateur & designer. Ensemble, nous donnerons vie à quelque chose d’exceptionnel !" />
            ...
            <div class="menu_header">
              <nav>
                <ul>
                  ...
                  <li>          
                    <a href="#competences" class="btn_round_small btn_nav_header">
                      <h4>À propos</h4>
                    </a>
                  </li>

                  <li>
                    <a href="#projets" class="btn_round_small btn_nav_header">
                      <h4>Projets</h4>
                    </a>
                  </li>
                
                  <li>
                    <a href="#contact" class="btn_round_small btn_nav_header">
                      <h4>Contact</h4>
                    </a>
                  </li>
    ...
    <div id="smooth-content">
        <div class="fond_footer">
                ...
                <div class="wrapper">
                    ...
                    <div class="competences__row">
                        <a
                            href="#"
                            class="btn_round"
                            data-tippy-content="<div class='tippycontent'> <div class='tippyelement'><svg class='icon icon_tippy'><use href='#icon-icon_ae'></use></svg> After effects</div> <div class='tippyelement'><svg class='icon icon_tippy'><use href='#icon-icon_reaper'></use></svg> Reaper</div> </div>"
                        >
                            <h4>
                                Montage audio
                                <em>&</em>
                        ...
                        <a
                            href="#"
                            class="btn_round"
                            data-tippy-content="<div class='tippyelement'> <svg class='icon icon_tippy'><use href='#icon-icon_blender'></use></svg> Blender </div>"
                        >
                        ...
                        <a
                            href="#"
                            class="btn_round"
                            data-tippy-content="<div class='tippycontent'> <div class='tippyelement'><svg class='icon icon_tippy'><use href='#icon-icon_ae'></use></svg> After effects</div>  <div class='tippyelement'> <svg class='icon icon_tippy'><use href='#icon-icon_blender'></use></svg>Blender</div> </div>"
                        >
                            <h4>
                                Animation 2D
                                <em>&</em>
                    ...
                    <div class="competences__row">
                        <a
                            href="#"
                            class="btn_round"
                            data-tippy-content="<div class='tippycontent'><div class='tippyelement'><svg class='icon icon_tippy'><use href='#icon-icon_deriative'></use></svg>TouchDesigner</div><div class='tippyelement'><svg class='icon icon_tippy'><use href='#icon-icon_unity'></use></svg>Unity</div> </div>"
                        >
                        ...
                        <a
                            href="#"
                            class="btn_round"
                            data-tippy-content="<div class='tippycontent'> <div class='tippyelement'><svg class='icon icon_tippy'><use href='#icon-icon_ps'></use></svg> Photoshop</div> <div class='tippyelement'><svg class='icon icon_tippy'><use href='#icon-icon_figma'></use></svg> Figma </div> <div class='tippyelement'><svg class='icon icon_tippy'><use href='#icon-icon_ai'></use></svg> Illustrator</div> </div> "
                        >
                        ...
                        <a
                            href="#"
                            class="btn_round"
                            data-tippy-content="<div class='tippycontent'> <div class='tippyelement'><svg class='icon icon_tippy'><use href='#icon-icon_html'></use></svg>HTML</div>  <div class='tippyelement'><svg class='icon icon_tippy'><use href='#icon-icon_css'></use></svg>CSS</div> <div class='tippyelement'><svg class='icon icon_tippy'><use href='#icon-icon_js__full'></use></svg>JavaScript</div> <div class='tippyelement'><svg class='icon icon_tippy'><use href='#icon-icon_php'></use></svg>PHP</div></div>"
                        >
            ...
            <section class="youtube section">
                <div class="wrapper">
                    <h2 class="scrolling_title">Présentation</h2>
                    <div class="video_container">
                        <div class="video border" data-component="YouTube" data-video-id="PZsVCQziuBU">
                            <div class="video__media js-video">
                                <img src="assets/icons/icon_play.svg" alt="Bouton play" class="icon_play" />

                                <img class="js-poster" src="assets/images/thumbnail_presentation.webp" alt="Présentation Projet" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="contact" class="contact section">
                <div class="wrapper">
                    ...
                    <div class="reseaux_contact__contact">
                        ...
                        <a href="CV-Philippe-Paquet.pdf" target="_blank" class="btn_reseau btn_round">
                    ...
                    <div class="reseaux_contact__reseaux">
                        ...
                        <a
                            href="https://www.linkedin.com/in/p-paquet?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
                            target="_blank"
                            class="btn_reseau btn_round"
                        >
                            <h4>LinkedIn</h4>
                        </a>
                            ...
                            <form action="index.php?action=send" class="form" autocomplete="off" data-component="Form" method="post">
                                <fieldset class="form__grid">
                                    ...
                                    <div class="input input--1">
                                        ...
                                        <input
                                            class="input__element border_text"
                                            type="text"
                                            name="tim_form_nom"
                                            id="fullname"
                                    ...
                                    <div class="input input--2">
                                        ...
                                        <input
                                            class="input__element border_text"
                                            type="email"
                                            name="tim_form_courriel"
                                            id="email"
                                            placeholder="VotreCourriel@domain.com"
                                            required
                                        />
                                    </div>
