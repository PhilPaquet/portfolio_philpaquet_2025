            ...
            <div class="menu_header">
                <nav>
                    <ul>
                        ...
                        <li>
                            <a href="index.html#competences" class="btn_round_small btn_nav_header">
                                <h4>À propos</h4>
                            </a>
                        </li>

                        <li>
                            <a href="index.html#projets" class="btn_round_small btn_nav_header">
                                <h4>Projets</h4>
                            </a>
                        </li>

                        <li>
                            <a href="index.html#contact" class="btn_round_small btn_nav_header">
                                <h4>Contact</h4>
                            </a>
                        </li>
